...
@Tag(
        name = "CRUD REST APIs for Cards in VCB",
...
public class CardController {
    ...
    @GetMapping("/fetch")
    public ResponseEntity<CardDto> fetchCardDetails(@RequestHeader("hnt-correlation-id") String correlationId,
    ...
    @Operation(
            ...
            description = "Card Info details that can be reached out in case of any issues"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
